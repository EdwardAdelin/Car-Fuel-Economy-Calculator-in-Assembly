...
global inputNum
	inputNum:
	section .data
		format1:		db		"Introduceti numarul dumneavoastra: ", 0
	...
	section .text
		;il salvam pe rbp in stack ca sa il putem reutiliza la final
		push rbp
		mov rbp, rsp

		; xmm1 o sa fie setat zero
		PXOR xmm1, xmm1

		; print
		printInfo format1, formatlength

		; macro (se vede in susul fisierului)
		takeInput number
